...
public abstract class TestCaseOutputGenerator : ITestCaseOutputGenerator
{
    ...
    protected IEnumerable<TestCase> FilterTestCasesByCategory(IEnumerable<TestCase> testCases, TestCaseCategory testCaseCategory)
    {
        return testCaseCategory switch
        {
            ...
            _ => testCases // TestCaseCategory.All - Keep all test cases
        };
    }
}
